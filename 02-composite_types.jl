...
# ╔═╡ ff6c8f95-7f92-4f71-899d-5d2c9c432168
? @elapsed
...
struct WizCur
	...
	function WizCur(galleons::Int, sickles::Int, knuts::Int)
		if knuts>=29
			knuts_new = knuts % 29;
			sickles = sickles + div(knuts,29);
			knuts=knuts_new;
			if sickles >=17
			sickles_new= sickles % 17;
				galleons= galleons + div(sickles,17);
				sickles=sickles_new;
			end
		end
...
# ╔═╡ dc162b1d-0a9a-4c3e-b5b7-5854b2b7f32d
...
# ╔═╡ 113e5ddd-50fb-4410-affa-ace9604a60ba
WizCur(10,30,50)

# ╔═╡ 5f7c75ac-5d94-11eb-137a-7914cd009821

function Base.show(io::IO, money::WizCur)
    print(io, "I am printed for WIZCUR, I have $(money.galleons)G, $(money.sickles)S, $(money.knuts)K")
end


# ╔═╡ 58a2e863-5472-4790-8632-a0e46a4bc4da
Money= WizCur(5, 40, 100);

# ╔═╡ 5a62ad91-4614-4a62-a704-e7b35e11a01d
Money.galleons

# ╔═╡ f4d660e3-dbe7-42da-8c08-28fcfe5a3cce
Base.show(Money::WizCur)

# ╔═╡ 95146d46-5d94-11eb-22aa-c1a544e0d784
Base.:+(m1::WizCur, m2::WizCur) = (m1.galleons + m2.galleons, m1.sickles + m2.sickles, m1.knuts + m2.knuts)
...
Base.size(V::Vandermonde) = (V.m, V.m);
...
Base.isless(m1::WizCur, m2::WizCur) = (m1.galleons*17*29+m1.sickles*29+m1.knuts)<(m2.galleons*17*29+m2.sickles*29+m2.knuts) ? "yes" : "no"
...
isgreater(m1::WizCur, m2::WizCur) = (m1.galleons*17*29+m1.sickles*29+m1.knuts) >(m2.galleons*17*29+m2.sickles*29+m2.knuts) ? 1 : 0

# ╔═╡ c3bbe308-7e77-4be4-8af1-72fa6c958c76
isgreater(money_ron, money_harry)

# ╔═╡ 9226b2d8-5d94-11eb-2bea-491eb7dc1da7
Base.isequal(m1::WizCur, m2::WizCur) =(m1.galleons*17*29+m1.sickles*29+m1.knuts)==(m2.galleons*17*29+m2.sickles*29+m2.knuts)  ? "yes" : "no"
...
# ╔═╡ 7310d3ba-a41d-43ab-93ea-6391410d10f4
