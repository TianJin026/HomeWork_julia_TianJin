...
# ╔═╡ 4b764ce2-70b1-4676-8ead-6537509da88a
let
z, y = true, false
...
begin
	for letter ∈ getme  # or, equivalently, use `∈` instead of `in` to look like a mathematician!
	  println("$letter")
	end
end
...
# ╔═╡ 176d0788-6661-4142-a544-50cea5d78830
...
# ╔═╡ dbd6257d-8e95-41ba-b1be-ad7e729b59c5
...
stirling(n) = n -> sqrt(2*π*n)*(n/exp(1))^n;

# ╔═╡ e16f2add-8b5c-44f3-b246-00e01bace6ab
begin
	nc=1:10;
	scatter(nc, factorials.(nc), label="accurate value")
	scatter!(nc, stirling(nc), label="approximation")
end
